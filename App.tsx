...
client
  .setEndpoint("YOUR_APPWRITE_ENDPOINT") // e.g., 'https://cloud.appwrite.io/v1' or 'http://localhost/v1'
  .setProject("YOUR_APPWRITE_PROJECT_ID"); // Your project ID from Appwrite console
...
const COLLECTION_ID = "YOUR_COLLECTION_ID"; // Example: for a 'users_data' collection
